...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(Long idReserva) {
		...
		lblRegistro.setIcon(new ImageIcon(MenuPrincipal.class.getResource("/imagenes/disquete.png")));
		lblRegistro.setBounds(0, 0, 50, 36);
		header.add(lblRegistro);
		...
		lblTitulo.setBounds(560, 66, 250, 42);
		...
		btnguardar.setBounds(650, 550, 130, 40);
		...
		btnAtras.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				...
				labelAtras.setForeground(Color.RED);
			}			
			@Override
		...
		btnAtras.setBackground(new Color(0, 128, 192));
		
		labelAtras = new JLabel("<");
		labelAtras.setHorizontalAlignment(SwingConstants.CENTER);
		labelAtras.setForeground(Color.WHITE);
		labelAtras.setFont(new Font("Tahoma", Font.BOLD, 24));
		labelAtras.setBounds(0, 0, 50, 50);
		...
		JLabel lblTitleReg = new JLabel("REGISTRO");
		lblTitleReg.setFont(new Font("Tahoma", Font.PLAIN, 24));
		lblTitleReg.setHorizontalAlignment(SwingConstants.CENTER);
		lblTitleReg.setForeground(new Color(0, 128, 255));
		lblTitleReg.setBounds(50, 0, 125, 36);
		header.add(lblTitleReg);
	}
	...
	private void guardarHuesped() {
		...
		if (txtFechaN.getDate() != null && !txtNombre.equals("") && !txtApellido.equals("") && !txtTelefono.equals("")) {		
			...
			HuespedesModel huespedes = new HuespedesModel(txtNombre.getText(), txtApellido.getText(),  java.sql.Date.valueOf(fechaN), txtNacionalidad.getSelectedItem().toString(),txtTelefono.getText(), nreserva);
			
			this.huespedesCTLR.guardar(huespedes);
